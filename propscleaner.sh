...
hexpatch_deleteprop "LSPosed" \
  ...
  "morokernel" "noble" "optimus" "slimroms" "sultan" "aokp" "bharos" "calyxos" "calyxOS" \
  "divestos" "emteria.os" "grapheneos" "indus" "iodéos" "kali" "nethunter" "omnirom" "paranoid" \
  "replicant" "resurrection" "rising" "remix" "shift" "volla" "icosa" "kirisakura" "infinity" "Infinity" \
